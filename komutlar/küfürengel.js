...
const db = require('quick.db')
    ...
    exports.run = (client, message, args) => {
        ...
        if(!args[0]){
            ...
            .setDescription(`**Küfür Engel Sistemini Açabilmek & Kapatabilmek İçin \`k!küfür-engel aç\`, \`k!küfür-engel kapat\``)
            .setColor('#36393F')
        ...
        if(args[0] === 'aç'){
            ...
            .setDescription(`**Küfür Engel Sistemini Başarılı Bir Şekilde Açtınız. Eğer Kaptmak İstersenizde** \`k!küfür-engel kapat\``)
            .setColor('#36393F')
        ...
        if(args[0] === 'kapat'){
            ...
            .setAuthor(`${message.author.username} - Başarılı`, message.author.avatarURL({dynamic: true}))
            .setDescription(`**Küfür Engel Sistemini Başarılı Bir Şekilde Kapattınız. Eğer Açmak İstersenizde** \`k!küfür-engel aç\``)
            .setColor('#36393F')
