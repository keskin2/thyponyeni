...
const db = require('quick.db')
    ...
    exports.run = (client, message, args) => {
        ...
        if(!args[0]){
            ...
            .setDescription(`**Reklam Engel Sistemini Açabilmek & Kapatabilmek İçin \`k!reklam-engel aç\`, \`k!reklam-engel kapat\``)
            .setColor('#36393F')
        ...
        if(args[0] === 'aç'){
            ...
            .setDescription(`**Reklam Engel Sistemini Başarılı Bir Şekilde Açtınız. Eğer Kaptmak İstersenizde** \`k!reklam-engel kapat\``)
            .setColor('#36393F')
        ...
        if(args[0] === 'kapat'){
            ...
            .setAuthor(`${message.author.username} - Başarılı`, message.author.avatarURL({dynamic: true}))
            .setDescription(`**Reklam Engel Sistemini Başarılı Bir Şekilde Kapattınız. Eğer Açmak İstersenizde** \`k!reklam-engel aç\``)
            .setColor('#36393F')
